import {Paper,Typography,Box,Pagination,Stack,Grid,} from "@mui/material";
  ...
  return (
    <>
      <Grid container spacing={4}>
        ...
        <img alt="..." src={blog1} style={{ width: "100%" }}  />  
        ...
        <Paper elevation={1} sx={{ p: 2, marginBottom: 5 }}>
          <Box data-aos="fade-up">
            <img alt="..." src={blog2} style={{ width: "100%" }} />
            <h2 className="orange-hover">
              Google inks pact for new 35-storey office
            </h2>
        ...
        <Paper elevation={1} sx={{ p: 2, marginBottom: 5 }} >
          <Box data-aos="fade-up">
            <img alt="..." src={blog3} style={{ width: "100%" }} />
            <h2 className="orange-hover">
              Google inks pact for new 35-storey office
            </h2>
            <Typography sx={{ fontSize: 14, color: "gray" }}>
        ...
        <Paper elevation={1} sx={{ p: 2, marginBottom: 5 }} >
          <Box data-aos="fade-up">
            <img alt="..." src={blog4} style={{ width: "100%" }} />
            <h2 className="orange-hover">
              Google inks pact for new 35-storey office
            </h2>
            <Typography sx={{ fontSize: 14, color: "gray" }}>
        ...
        <Paper elevation={1} sx={{ p: 2, marginBottom: 5 }}>
          <Box data-aos="fade-up">
            <img alt="..." src={blog5} style={{ width: "100%" }} />
            <h2 className="orange-hover">
              Google inks pact for new 35-storey office
            </h2>
            <Typography sx={{ fontSize: 14, color: "gray" }}>
